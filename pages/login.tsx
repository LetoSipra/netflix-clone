...
function Login() {
  ...
  return (
    <div className='relative flex h-screen w-screen flex-col bg-black md:items-center md:justify-center md:bg-transparent'>
      ...
      <Image
        src='https://www.linkpicture.com/q/AE-en-20220321-popsignuptwoweeks-perspective_alpha_website_large.jpg'
        fill
        alt='login'
      ...
      <form
        ...
        <div className='text-[gray]'>
          New to Netflix?
          <button type="submit" onClick={() => setLogin(false)} className='pl-2 text-white hover:underline'>
            Sign up now
          </button>
        </div>
      </form>
